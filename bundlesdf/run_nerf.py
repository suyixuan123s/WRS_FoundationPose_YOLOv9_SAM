...
def run_neural_object_field(cfg, K, rgbs, depths, masks, cam_in_obs, debug=0, save_dir='/home/bowen/debug_mustard0/foundationpose_bundlesdf'):
...
if __name__=="__main__":
  ...
  code_dir = os.path.dirname(os.path.realpath(__file__))
  parser.add_argument('--ref_view_dir', type=str, default=f'/home/suyixuan/AI/Pose_Estimation/FoundationPose/demo_data/linemod/ref_views')
  parser.add_argument('--dataset', type=str, default=f'linemod', help='one of [ycbv/linemod]')
