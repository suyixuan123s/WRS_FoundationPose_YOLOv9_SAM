# 20201124 I am running physics for meshes. When using millimeter as the metrics, my frame rate reaches to 60fps,
# but when I change them to meters, the number lowers down to 1fps or less. I am wondering if I did a wrong option.

# 我正在为网格运行物理.当使用毫米作为度量时,我的帧率达到60fps
# 但是当我将它们更改为米时,数字会降低到1fps或更少.我在想我是不是选错了
