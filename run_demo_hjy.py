...
if __name__ == '__main__':
    ...
    # parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/kinect_driller_seq/mesh/textured_mesh——缩放后.obj')
    # parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/kinect_driller_seq')
    # parser.add_argument('--est_refine_iter', type=int, default=5)
    # parser.add_argument('--track_refine_iter', type=int, default=2)
    # parser.add_argument('--debug_mustard0', type=int, default=3)
    # parser.add_argument('--debug_dir', type=str, default=f'{code_dir}/debug_kinect_driller_seq')
    # args = parser.parse_args()

    # parser = argparse.ArgumentParser()
    # code_dir = os.path.dirname(os.path.realpath(__file__))
    # parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/milk_data/textured_mesh——缩放后.obj')
    # parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/milk_data')
    # parser.add_argument('--est_refine_iter', type=int, default=5)
    # parser.add_argument('--track_refine_iter', type=int, default=2)
    # parser.add_argument('--debug', type=int, default=3)
    # parser.add_argument('--debug_dir', type=str, default=f'{code_dir}/debug_milk')
    # args = parser.parse_args()

    # parser = argparse.ArgumentParser()
    # code_dir = os.path.dirname(os.path.realpath(__file__))
    # parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/rack/mesh/textured_mesh——缩放后.obj')
    # parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/rack')
    # parser.add_argument('--est_refine_iter', type=int, default=5)
    # parser.add_argument('--track_refine_iter', type=int, default=2)
    # parser.add_argument('--debug', type=int, default=3)
    # parser.add_argument('--debug_dir', type=str, default=f'{code_dir}/debug_data/rack')
    # args = parser.parse_args()
    ...
    # parser.add_argument('--track_refine_iter', type=int, default=2)
    # parser.add_argument('--debug', type=int, default=3)
    # parser.add_argument('--debug_dir', type=str, default=f'{code_dir}/debug_data/kinect_driller_seq')
    # args = parser.parse_args()

    # # 10ml_metal_rack_copy
    # parser = argparse.ArgumentParser()
    # code_dir = os.path.dirname(os.path.realpath(__file__))
    # parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/10ml_metal_rack_copy/mesh/1.obj')
    # parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/10ml_metal_rack_copy')
    # parser.add_argument('--est_refine_iter', type=int, default=5)
    # parser.add_argument('--track_refine_iter', type=int, default=2)
    # parser.add_argument('--debug', type=int, default=3)
    # parser.add_argument('--debug_dir', type=str, default=f'{code_dir}/debug_data/10ml_metal_rack_copy')
    # args = parser.parse_args()
    ...
    # parser = argparse.ArgumentParser()
    # code_dir = os.path.dirname(os.path.realpath(__file__))
    # parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/10ml_rack1/mesh/1.obj')
    # parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/10ml_rack1')
    # parser.add_argument('--est_refine_iter', type=int, default=5)
    # parser.add_argument('--track_refine_iter', type=int, default=2)
    # parser.add_argument('--debug', type=int, default=3)
    # parser.add_argument('--debug_dir', type=str, default=f'{code_dir}/debug_data/hujiaying/10ml_rack1123')
    # args = parser.parse_args()
