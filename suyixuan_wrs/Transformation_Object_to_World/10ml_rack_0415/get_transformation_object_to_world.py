...
transformation_camera_to_sim = np.array([[0.999848, 0.012058, 0.012618, 0.420000],
                                         [0.000000, -0.722967, 0.690882, -0.680000],
                                         [0.017452, -0.690777, -0.722857, 0.890000],
                                         [0.000000, 0.000000, 0.000000, 1.000000]])


# [[0.999848, 0.012058, 0.012618, 0.420000]
#  [0.000000, -0.722967, 0.690882, -0.680000]
#  [0.017452, -0.690777, -0.722857, 0.890000]
#  [0.000000, 0.000000, 0.000000, 1.000000]]
...
object_to_camera = np.array(
    [[-0.8378788232803345, 0.5458102226257324, -0.0070709241554141045, 0.17179563641548157],
     [0.4041435718536377, 0.6115933060646057, -0.6801630854606628, 0.12652096152305603],
     [-0.36691543459892273, -0.5727518796920776, -0.7330268621444702, 1.0478436946868896],
     [0.0000000000000000, 0.0000000000000000, 0.0000000000000000, 1.0000000000000000]])
...
# 指定文件路径
file_path = "transformation_object_to_world.txt"

# 检查目录是否存在,如果不存在则创建
directory = os.path.dirname(file_path)
if directory:  # 仅当 directory 不为空时创建目录
