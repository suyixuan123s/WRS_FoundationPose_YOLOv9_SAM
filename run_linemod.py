...
#   code_dir = os.path.dirname(os.path.realpath(__file__))
#   parser.add_argument('--linemod_dir', type=str, default="/media/suyixuan_sam/Suyixuan/AI/Pose_Estimation/FoundationPose/demo_data/LINEMOD", help="linemod root dir")
#   parser.add_argument('--use_reconstructed_mesh', type=int, default=1)
#   parser.add_argument('--ref_view_dir', type=str, default="/home/suyixuan_sam/AI/Pose_Estimation/FoundationPose/demo_data/linemod/ref_views")
#   parser.add_argument('--debug', type=int, default=3)
#   parser.add_argument('--debug_dir', type=str, default=f'{code_dir}/debug_data/debug_LINEMOD1')
...
#   set_seed(0)
  ...
  if __name__ == '__main__':
    ...
    parser.add_argument('--linemod_dir', type=str,
                        default="/media/suyixuan_sam/Suyixuan/AI/Pose_Estimation/FoundationPose/demo_data/linemod",
                        help="linemod root dir")
    parser.add_argument('--use_reconstructed_mesh', type=int, default=1)
    parser.add_argument('--ref_view_dir', type=str,
                        default="/home/suyixuan_sam/AI/Pose_Estimation/FoundationPose/demo_data/linemod/ref_views")
    parser.add_argument('--debug', type=int, default=3)
    parser.add_argument('--debug_dir', type=str, default=f'{code_dir}/debug_data/debug_linemod1')
    opt = parser.parse_args()
    set_seed(0)
