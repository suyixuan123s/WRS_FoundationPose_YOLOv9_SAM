...
class XArmLite6WRSGripper(ri.RobotInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), name='xarm_lite6', enable_cc=True):
        ...
        # left side
        self.base_plate = jl.JLChain(pos=pos, rotmat=rotmat, homeconf=np.zeros(0), name='lft_base_plate_jl')

        # arm
        self.arm = XArmLite6(pos=self.base_plate.jnts[-1]['gl_posq'],
    ...
    def enable_cc(self):
        ...
        # lnks used for arm-base_plate collision detection
        ...
        # lnks used for arm-base_plate collision detection -- extra
        # fromlist = [self.base_plate.lnks[0]]  # base_plate
    ...
    def fix_to(self, pos, rotmat):
        self.pos = pos
        self.rotmat = rotmat
        self.base_plate.fix_to(self.pos, self.rotmat)
    ...
    def gen_stickmodel(self,
        ...
        self.base_plate.gen_stickmodel(tcp_loc_pos=None,
                                 tcp_loc_rotmat=None,
                                 toggle_tcpcs=False,
    ...
    def gen_meshmodel(self,
        ...
        self.base_plate.gen_meshmodel(tcp_loc_pos=None,
                                tcp_loc_rotmat=None,
                                toggle_tcpcs=False,
                                toggle_jntscs=toggle_jntscs,
