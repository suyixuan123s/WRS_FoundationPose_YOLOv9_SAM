...
if __name__ == '__main__':
    ...
    base = wd.World(cam_pos=[3.7, -2.7, 1.7], lookat_pos=[1.5, 0, .3])
    gm.gen_frame().attach_to(base)
    # show stick model/mesh model/collision model
    robot_s = TBMChanger(enable_cc=True)
    robot_s_stickmodel = robot_s.gen_stickmodel()
