...
if __name__ == '__main__':
    ...
    # tube1.set_pos(np.array([.555, -.5, 0.113-0.015]))
    # tube1.set_rotmat()
    ...
    # tube2.set_pos(np.array([.585, -.5, 0.113-0.015]))
    # tube2.set_rotmat()
    ...
    tube3.set_pos(np.array([.615, -.5, 0.113-0.015]))
    tube3.set_rotmat()
    ...
    # tube5.set_pos(np.array([.645, -.475, 0.113-0.015]))
    # tube5.set_rotmat()
    ...
    # obj.set_pos(np.array([.615, -.5, 0.113-0.015]))
    # obj.set_rotmat()
    # obj.attach_to(base)
    ...
    # obj_goal.set_pos(np.array([.645, -.5, 0.113-0.015]))
    # obj_goal.set_rotmat()
    ...
    grasp_info_list = gpa.load_pickle_file(tube_name, root=None, file_name='dh76_grasps_blood.pickle')

    start_pos = tube3.get_pos()
    start_rotmat = tube3.get_rotmat()
    # goal_pos = obj_goal.get_pos()
    # goal_rotmat = obj_goal.get_rotmat()
    goal_pos = np.array([.645, -.5, 0.113 - 0.015])
