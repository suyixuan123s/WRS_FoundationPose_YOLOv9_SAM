...
objpath = os.path.join(this_dir, 'objects', 'rack_10ml_new_center.STL')
...
grasp_info_list = gpa.plan_grasps(gripper_s,
                                  ...
                                  contact_offset=.003)
gpa.write_pickle_file('rack_10ml_new_center', grasp_info_list, './', 'ag145_grasps_rack_10ml_new_center.pickle')
