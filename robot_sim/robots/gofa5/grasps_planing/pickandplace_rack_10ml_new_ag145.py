...
if __name__ == '__main__':
    ...
    transformation_camera_to_sim = np.array([[-0.83750804, 0.54587487, - 0.02452059, 0.6065168],
                                             [-0.54567773, - 0.83786574, - 0.0146996, - 0.04753413],
                                             [-0.02856836, 0.0010686, 0.99959121, 0.04815926],
                                             [0., 0., 0., 1.]])
    ...
    approach_dis = -0.05  # 定义接近距离,通常用于计算接近位置
    ...
    for path_id, item in enumerate(init_grasp_jnts_list):
        try:
            ...
            # plt.savefig(f"path_data1/path{path_id}.png")
            # plt.show()
