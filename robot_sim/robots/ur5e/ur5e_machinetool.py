...
class UR5EMachinetool(ri.RobotInterface):
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), name="ur5e_machinetool", enable_cc=True):
...
if __name__ == '__main__':
    ...
    robot_s = UR5EMachinetool(enable_cc=True)
    robot_s.jaw_to(.02)
