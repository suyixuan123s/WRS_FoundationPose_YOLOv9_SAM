...
class Gofa12Arm(mi.ManipulatorInterface):
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(6), name='gofa12_arm', enable_cc=True):
...
if __name__ == '__main__':
    ...
    manipulator_instance = Gofa12Arm(enable_cc=True)
