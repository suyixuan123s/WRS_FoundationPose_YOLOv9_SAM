...
class RRTConnect(rrt.RRT):
    ...
    def plan(self,
        ...
        tree_a_goal_conf_list = [self.roadmap_goal_list[i].nodes['goal']['conf'] for i in range(len(self.roadmap_goal_list))]
        ##################################################################
...
if __name__ == '__main__':
    ...
    path = rrtc.plan(component_name='all', start_conf=np.array([0, 0]), goal_conf=np.array([5, 10]), goal_conf_list=[[5, 10], [10, 15], [0, 15]],
                     obstacle_list=obstacle_list,
