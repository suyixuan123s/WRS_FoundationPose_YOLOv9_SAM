...
import robot_sim.robots.gofa5.gofa5_camera as gf5    #gofowithag 将爪子加入了cc
...
if __name__ == '__main__':
    ...
    obj1 = cm.CollisionModel(
        r'D:\wrs-fujikoshi-main-1217\0000_placementplanner\objects\tixing.STL')  ##\是linux系统路径  /windows系统  r-将linux转为windows
    ...
    grasp_info_list=gpa.load_pickle_file(objcm_name="tixing",root=None,file_name="objti_grasptest_250108.pickle")  ##294
